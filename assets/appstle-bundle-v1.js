  ...
  checkReady(function($) {
    $(function() {
      ...
      function createVariantBundleHTML(variantLevelBundles, currentVariantData, currentProductData) {
        var bundleTemplate = `<div class="as-bundle-wrapper" data-bundle-id={{bundle.id}}>
                  ...
                  <div class="as-current-product" data-product-handle="{{{currentProductData.handle}}}">
                    <img class="as-checkmark" src="https://ik.imagekit.io/mdclzmx6brh/icons8-verified-check-circle-for-approved-valid-content-24_pMmnUT90W.png">
                    ...
                    <div class="as-bundle-product_details">
                      ...
                      <div class="as-current-product_price">
                          <span class="as-sale-price">{{{currentVariantData.formattedPrice}}}</span>&nbsp;<span class="as-original-price">{{{currentVariantData.formattedOriginalPrice}}}</span>
                      </div>
                  ...
                  <div class="as-bundle-product" data-product-handle="{{{productHandle}}}">
                    ...
                    <div class="as-bundle-product_details">
                      ...
                      <div class="as-bundle-product_price">
                         <span class="as-sale-price">{{{formattedPrice}}}</span>&nbsp;<span class="as-original-price">{{{formattedOriginalPrice}}}</span>
                      </div>
                      <div class="as-select-wrapper">
                        <div class="as-variant-select-wrapper" style="display: none;">
                          <label class="as-select-label">${RS?.Config?.bundle?.variant || 'Variant'}</label>
                  ...
                  <div class="as-bundle-checkout-wrapper">
                    <div class="as-bundle-primary-button as-bundle-cart">
        ...
        variantLevelBundles.forEach(bundle => {
          var data = {
            variants: filterVariants(bundle.variants),
            currentVariantData: bundle.variants.find(variant => variant.id === parseInt(getCurrentVariant())),
      ...
      function createProductBundleHTML(productLevelBundles, productData) {
        var bundleTemplate = `<div class="as-bundle-wrapper" data-bundle-id={{bundle.id}}>
                  ...
                  <div class="as-current-product" data-product-handle="{{{currentProductData.productData.handle}}}">
                    ...
                    <div class="as-bundle-product_details">
                      ...
                      <div class="as-bundle-product_price">
                          <span class="as-sale-price">{{{currentProductData.formattedPrice}}}</span>&nbsp;<span class="as-original-price">{{{currentProductData.formattedOriginalPrice}}}</span>
                      </div>
                      <div class="as-select-wrapper">
        ...
        productLevelBundles.forEach(bundle => {
          var data = {
            products: filterCurrentProduct(bundle.products),
            currentProductData: bundle.products.find(product => product.id === RSConfig.product.id),
            bundle: bundle
          };
          var template = Mustache.render(bundleTemplate, data);
          bundle.template = template;
      ...
      function addBundleToCart(instance, variants) {
        jQuery
          .post(window.Shopify.routes.root + 'cart/add.js', { items: variants })
          .done(function(cart) {
            getDiscountCodeAndCheckout(instance);
          })
          .fail(function() {
      ...
      function modifyPricesBasedOnSellingPlan(productData, variantData, variantId, sellingPlanId, instance) {
        ...
        var bundleId = parseInt(
          jQuery(instance)
            .parents('.as-bundle-wrapper')
            .data('bundle-id')
        );
        var bundle = getBundleDataById(bundleId);
      ...
      function getCurrentVariant() {
        return globalUrlParameter || jQuery('[name=id]').val();
      }
...
.as-variant-select, .as-sellingPlan-select {
  padding: 5px;
  border-radius: 8px;
}
...
.as-sellingPlan-select-wrapper {
  flex-shrink: 1;
  width: 100%;
}

.as-sellingPlan-select {
  width: 100%;
}
